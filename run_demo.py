...
if __name__=='__main__':
    ...
    parser.add_argument("--mono_depth", action="store_true", help="Estimate metric depth from the RGB image instead of reading demo_data/depth.png. Combine with --img_to_3d for a fully RGB-only pipeline (no depth sensor required).")
